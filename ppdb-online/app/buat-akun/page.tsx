// app/buat-akun/page.tsx
export default function BuatAkun() {
  return (
    <main className="max-w-md mx-auto mt-20 p-6 bg-white rounded-xl shadow text-blue-900">
      <h1 className="text-2xl font-bold mb-4 text-center">Buat Akun Baru</h1>
      <form className="space-y-4">
        <input type="text" placeholder="Nama Lengkap" className="w-full border px-3 py-2 rounded" />
